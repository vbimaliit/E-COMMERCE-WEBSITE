...
public class VeiworderServlet extends HttpServlet {
    ...
    ordercheck = MySqlDataStoreUtilities.viewOrder();
		 
	if(ordercheck.containsKey(ordernumber)){
	
          Order order = (Order)ordercheck.get(ordernumber);
	...
	out.println("<div class=\"width\">");
  		  out.println("<ul>");
         	  out.println("<li class=\"start\"><a href=\"index.html\">Home</a></li>");
				...
				out.println("<li style = \"float:right\"> <a href=\"viewworder.html\">Vieworder</a></li>");
    ...
    out.println("<div id=\"body\" class=\"width\">");
		...
		out.println("<table>");
		 ...
		 out.println("</td>");
		  ...
		  out.println("<form method=\"get\" action=\"/csj/CancelorderServlet\">");
...
out.println("</html>");
         ...
         }else{msg = "Ordernumber does not exists";
		 		  	   out.println("<!doctype html>");
	   out.println("<html>");
       out.println("<head>");
       out.println("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />");
...
out.println("</html>");}
	    ...
	    { msg = "Ordernumber does not exists ";
			   out.println("<html>");
       out.println("<head>");
       out.println("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />");
       out.println("<title>Bestdeal.com</title>");
