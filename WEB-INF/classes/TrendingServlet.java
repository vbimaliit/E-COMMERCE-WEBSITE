...
public class TrendingServlet extends HttpServlet {
    ...
    out.println("<div id=\"body\" class=\"width\">");
	    ...
	    out.println("<article>");
		out.println("<h3>Most Liked product </h3>"); 
		out.println("<table>");
        ...
        out.println("<h3>Most sold product irrespective of rating </h3>"); 
		out.println("<table>");
		...
		out.println("<h3>Top 5 zips where max number of product reviewed</h3>"); 
		out.println("<table>");
