...
public class CheckoutServlet extends HttpServlet {
	...
	HashMap <String ,Cart > Order = new HashMap<String , Cart> ();
//    Cart cart;
//		HashMap <String ,Cart > Valuecart;
  ...
  public void doGet(HttpServletRequest request,
	  ...
	  Order = (HashMap)session.getAttribute("shoppingCart");
      ...
      while(iterator.hasNext()) {
         Map.Entry mentry = (Map.Entry)iterator.next();
          Cart cart1 = (Cart)mentry.getValue();
			 ...
			 out.println("<form action=\"/csj/OrdercompleteServlet\">");
			 out.println("<tr>") ;
			 out.println("<td>Creditcardnumber</td>");
			 out.println("<td><input type=\"text\" size=\"16\" name=\"creditcardnumber\" style= \"background-color: white\"></input></td>");
             out.println("</tr>");
             out.println("<tr>");	
             out.println("<td>Address</td>");
             out.println("<td><input type=\"text\" size=\"15\" name=\"address\" style= \"background-color: white\"/></td>");
             out.println("</tr>");
			 out.println("<tr>") ;
			 out.println("<td>");
