...
//	  HashMap <String ,String> reviews = new HashMap<String , String> ();
	...
	String reviewdate = formatdate.format(current);
	  
	String  productname = request.getParameter("productname");
	System.out.println(productname);
	String username = "vishal";
	String  producttype = request.getParameter("produdcttype");
	...
	MongoDBDataStoreUtilities.insertReviews(productname,producttype,price,retailer,retailerzip,retailercity,retailerstate,productonsale,manufacturer,manufacturerebate,username,userage,usergender,useroccupation,rating,reviewdate,reviews);
    ...
    out.println("<div id=\"body\" class=\"width\">");
	    ...
	    out.println("<article>");
        out.println("Review Stored successfully"); 
     	out.println("</article>");
        out.println("</section>");
